...
export const SCIPY_SECOND_QUIZZES = {
  ...
  "scipy-19": q(
    "You already have a NumPy matrix. Why open `scipy.linalg`?",
    [
      "To use matrix tools like det, solve, and eigvals",
      "To change only CSS colors",
      "Because NumPy arrays cannot store numbers",
      "To send HTTP requests only",
    ],
    0,
    "scipy.linalg adds matrix solvers and measures on top of NumPy arrays.",
  ),
  "scipy-20": q(
    "After `x = linalg.solve(A, b)`, why print `A @ x`?",
    [
      "To check that the answer fits the equations (matches b)",
      "To delete matrix A from memory",
      "To turn x into a pie chart",
      "Because solve always returns None",
    ],
    0,
    "A @ x should match b if your solution is correct.",
  ),
  "scipy-21": q(
    "A guitar string has natural notes it likes to vibrate at. Which idea matches that story?",
    [
      "Eigenvalues — special stretch / mode factors of a matrix",
      "interp1d — fill gaps in GPS tracks",
      "gamma — factorial-style products only",
      "find_peaks — only for sorting integers",
    ],
    0,
    "Eigenvalues connect to natural modes and stretch factors — a friendly vibration intuition.",
  ),
  "scipy-22": q(
