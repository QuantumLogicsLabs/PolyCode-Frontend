...
const LEARNING_PATH = [
  ...
  {
    level: "Advanced",
    chapters: ["a11y-aria-screen-readers"],
    color: "#7c3aed",
    summary: "ARIA roles, accessible names, and live regions for dynamic content.",
  },
  {
    level: "Expert",
    chapters: ["a11y-color-forms"],
    color: "#dc2626",
    summary: "Color contrast, not relying on color alone, and accessible forms.",
  },
];
